...
namespace Rowlet.Core
{
    internal class LJProcessor : IPageProcessor
    {
        ...
        public LJProcessor SetRequestExtractor(IRequestExtractor requestExtractor)
        {
            RequestExtractor = requestExtractor;
            return this;
        }

        public LJProcessor SetFilter(IFilter filter)
        {
            Filter = filter;
            return this;
        }

        public LJProcessor SetLastPageChecker(ILastPageChecker lastPageChecker)
        {
